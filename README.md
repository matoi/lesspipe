...
The main web page is on [lesspipe.org](https://lesspipe.org)

A thorough analysis of the program has been generated by Devin at [deepwiki](https://deepwiki.com/wofr06/lesspipe/1-overview)

The development version can be cloned using git:
 `git clone https://github.com/wofr06/lesspipe.git`
You can report bugs or make proposals to improve lesspipe on GitHub or contact
the author by email [(wp.friebel@gmail.com)](mailto:wp.friebel@gmail.com).
...
- device tree blobs	requires `dtc` (extension dtb or dts)
 ...
 The color scheme used is for a light background. To select the dark color
 scheme the ENV variable XMQ_THEME has to be set to the value dark.
